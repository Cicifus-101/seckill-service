...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.MainImage = field.NewString(tableName, "main_image")
...
type product struct {
	...
	ALL        field.Asterisk
	ID         field.Uint64 // 商品id
	Name       field.String // 商品名称
	Subtitle   field.String // 商品副标题/卖点
	MainImage  field.String // 主图地址
	Detail     field.String // 商品详情
	Status     field.Int32  // 状态：1-上架，2-下架
