...
import (
	...
	"seckill-service/cmd/gen/internal/data/product/model"
)
...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.ID = field.NewUint32(tableName, "id")
	_category.ParentID = field.NewUint32(tableName, "parent_id")
...
type category struct {
	...
	ALL        field.Asterisk
	ID         field.Uint32 // 分类id
	ParentID   field.Uint32 // 父分类id，0表示根节点
	Name       field.String // 分类名称
	SortOrder  field.Int32  // 排序值
	Status     field.Int32  // 状态：1-正常，2-废弃
