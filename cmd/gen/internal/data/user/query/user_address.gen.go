...
import (
	...
	"seckill-service/cmd/gen/internal/data/user/model"
)
...
func newUserAddress(db *gorm.DB, opts ...gen.DOOption) userAddress {
	...
	_userAddress.DetailAddress = field.NewString(tableName, "detail_address")
	_userAddress.IsDefault = field.NewUint32(tableName, "is_default")
	_userAddress.IsDelete = field.NewUint32(tableName, "is_delete")
	_userAddress.CreateTime = field.NewTime(tableName, "create_time")
	_userAddress.UpdateTime = field.NewTime(tableName, "update_time")
...
type userAddress struct {
	...
	ReceiverPhone field.String // 收货人手机号
	Province      field.String // 省份
	City          field.String // 城市
	District      field.String // 区/县
	DetailAddress field.String // 详细地址
	IsDefault     field.Uint32 // 是否默认地址：0-否，1-是
	IsDelete      field.Uint32 // 是否删除：0-未删，1-已删
...
func (u *userAddress) updateTableName(table string) *userAddress {
	...
	u.IsDefault = field.NewUint32(table, "is_default")
	u.IsDelete = field.NewUint32(table, "is_delete")
